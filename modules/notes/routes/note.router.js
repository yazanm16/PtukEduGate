...
const {createNoteValidation, deleteNoteValidation, updateNoteValidation, noteListValidation} = require("../validation/note.validation");
...
router.get('/note-list',Authenticated,authorizeRoles('student','admin','superadmin'),noteListValidation,validate,listNotesByGet)
