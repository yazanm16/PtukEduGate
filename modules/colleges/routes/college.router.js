...
const {createCollegeByPost, deleteCollegeByDelete, getCollegesByGet} = require("../controller/college.controller");
const {createCollegeValidation, deleteCollegeValidation, getCollegesValidation} = require("../validation/college.validation");
